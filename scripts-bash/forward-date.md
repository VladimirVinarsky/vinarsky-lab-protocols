---
description: takes a date and integers, forwards the date outputs in different format
---
...
#!/bin/bash
 ...
 shifted_date=$(date '+%Y-%m-%d' -d "$reformatted_start_date+$shift_ days days")
...
{% file src="../.gitbook/assets/script_date-shift.sh" %}
